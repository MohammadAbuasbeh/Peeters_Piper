...
def piper(arrays, plottitle, use_color, fig=None, **kwargs):
    ...
    plt.text(0.43, h + offset, u'$Mg^{2+}$', horizontalalignment='center', verticalalignment='center')
    ...
    plt.text(1.56 + 2 * offset, h + offset, u'$SO_4^{2-}$', horizontalalignment='center', verticalalignment='center')
